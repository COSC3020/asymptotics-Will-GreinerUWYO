...
1: already done 2: 4 - These functions both grow at speed c(n) 3: 2 - f(n) grows at speed n^5, faster than n^2 4: 1 - f(n) grows much slower at log10 than n 5: 2 - n^5 is faster than n^4 6: 2 - 10^256 is much faster than logn 7: 1 - n^2 is much slower than 2^n
